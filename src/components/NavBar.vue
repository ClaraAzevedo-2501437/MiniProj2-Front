      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto mr-5">
          ...
          <b-nav-item :to="{ name: 'quizzes' }" :disabled="!isUserLoggedIn"
            >QUIZZES</b-nav-item
          >
          <b-nav-item :to="{ name: getUserType === 'admin' ? 'listSponsors' : 'sponsors' }" :disabled="!isUserLoggedIn"
            >PATROCINADORES</b-nav-item
          >
          <b-nav-item :to="{ name: getUserType === 'admin' ? 'listExperts' : 'experts' }" :disabled="!isUserLoggedIn"
